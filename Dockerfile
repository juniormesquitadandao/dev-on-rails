...
RUN [[ -z "$BUNDLER_VERSION" ]] && { echo "Arg BUNDLER_VERSION can't be blank."; exit 1; } || { echo "BUNDLER_VERSION: $BUNDLER_VERSION"; };
RUN [[ -z "$NODE_VERSION" ]] && { echo "Arg NODE_VERSION can't be blank."; exit 1; } || { echo "NODE_VERSION: $NODE_VERSION"; };
RUN [[ -z "$NPM_VERSION" ]] && { echo "Arg NPM_VERSION can't be blank."; exit 1; } || { echo "NPM_VERSION: $NPM_VERSION"; };
